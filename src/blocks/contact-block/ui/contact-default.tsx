      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 xl:gap-20 items-center">
        ...
        <div className="flex flex-col lg:order-2 space-y-4 sm:space-y-6 lg:space-y-8">
          <div className="space-y-2 sm:space-y-3">
            ...
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl font-bold">
              {fields.heading}
            </h2>
          </div>
          ...
          <div className="flex flex-col gap-3 sm:gap-4 lg:gap-6 mt-6 sm:mt-8 lg:mt-10">
            <a 
              ...
              className="text-primary text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-semibold hover:underline transition-colors duration-200"
            >
              +7 (343) 287-77-89
            </a>
            <a 
