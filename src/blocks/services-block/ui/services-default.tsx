...
export function ServicesBlockDefault({ fields }: Props) {
  return (
    <div className="flex flex-col gap-4 sm:gap-6 lg:gap-8">
      ...
      <div className="container my-6 sm:my-8 lg:my-12 mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 px-4 sm:px-6 lg:px-8">
        {fields.services.map(
          (service) =>
